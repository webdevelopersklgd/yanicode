...
<form action="" class="js-validated-form">
    <div class="popup-feedback__input-cover">
        ...
        <input
                type="text"
                class="popup-feedback__input js-validated-field"
    ...
    <div class="popup-feedback__double-column">
        <div class="popup-feedback__input-cover">
            ...
            <input
                    type="tel"
                    class="popup-feedback__input mask-phone-js js-validated-field"
                    data-validated_name="phone"
            />
        </div>
        <div class="popup-feedback__input-cover">
    ...
    <div class="popup-feedback__consent">
        <div class="popup-feedback__consent-form-wrapper">
            <input
                    class="popup-feedback__consent-input"
                    id="consent1"
                    type="checkbox"
                    checked="checked"
            />
        ...
        <div class="popup-feedback__consent-form-wrapper">
            ...
            <label class="popup-feedback__consent-form" for="consent2">
                <a href="./article-privacy-policy.html" target="_blank">
                    Оставляя данные на Сайте, заполняя регистрационную форму, Вы
                    соглашаетесь с настоящей Политикой конфиденциальности.
                </a>
            </label>
        </div>
    </div>
